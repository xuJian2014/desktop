...
public class VncCanvasActivity extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		/*//未读取到相应的远程桌面信息
		if(IP=="0000" || password=="0000"){
			Intent iTouch = new Intent(this, VncCanvasActivity.class);
			startActivity(iTouch);    //直接返回到“智能家庭终端”
			Toast.makeText(VncCanvasActivity.this, "远程连接IP或者密码认证失败!", Toast.LENGTH_LONG).show();
		}*/
		...
		if ((data != null) && (data.getScheme().equals("vnc"))) {
			...
			// String host = "192.168.1.102:5900";
			...
			System.out.println("VncCanvasActivity:" + host);
