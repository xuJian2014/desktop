...
public class EasyTouchView extends View
{
	...
	{
		mSettingTable = LayoutInflater.from(mContext).inflate(
				R.layout.phone_show_setting_table, null); // 手机

		View mSettingTableView = mSettingTable
				.findViewById(R.id.touch_setting_table);
		mSettingTableView.getBackground().setAlpha(200);

		ImageView mouseButton = (ImageView) mSettingTable
				.findViewById(R.id.show_setting_table_item_mouse_button);
		ImageView keyboardButton = (ImageView) mSettingTable
				.findViewById(R.id.show_setting_table_item_virturlkeyboard_button);
		ImageView keymouseButton = (ImageView) mSettingTable
				.findViewById(R.id.show_setting_table_item_keymouse_button);

		ImageView miracastButton = (ImageView) mSettingTable
				.findViewById(R.id.show_setting_table_item_miracast_button);
		ImageView mainButton = (ImageView) mSettingTable
				.findViewById(R.id.familyterminal_button);
		ImageView settingButton = (ImageView) mSettingTable
				.findViewById(R.id.show_setting_table_item_setting_button);

		ImageView backButton = (ImageView) mSettingTable
				.findViewById(R.id.show_setting_table_item_back_button);
		ImageView homeButton = (ImageView) mSettingTable
				.findViewById(R.id.show_setting_table_item_home_button);
		ImageView exitTouchButton = (ImageView) mSettingTable
				.findViewById(R.id.show_setting_table_item_exit_touch_button);
	...
	private OnClickListener mClickListener = new OnClickListener() {
		...
		public void onClick(View v)
		{
			...
			case R.id.show_setting_table_item_setting_button:
				...
				/*
				 * Intent iSeting = new Intent(); iSeting.setClass(mContext,
				 * MainActivity.class);
	...
	private OnTouchListener mTouchListener = new OnTouchListener() {
		...
		private void motionActionUpEvent(float x, float y)
		{
			...
			{
				mPopuWin = new PopupWindow(mSettingTable,
				...
				// TODO
				mIconImageView.setBackgroundDrawable(getResources()
	...
	Handler handler = new Handler() {
		...
		{
			mIconImageView.setBackgroundDrawable(getResources().getDrawable(
					R.drawable.touch_ic4));
		};
	};
