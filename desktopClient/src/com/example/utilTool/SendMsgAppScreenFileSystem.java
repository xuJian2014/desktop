...
public class SendMsgAppScreenFileSystem implements Runnable
{
	private final int TIME_OUT=60*1000;//最大响应时间，超时设置
		...
		public SendMsgAppScreenFileSystem(Handler handler,Activity activity,String requestStr) 
		{
			super();
