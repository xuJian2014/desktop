...
public class Send_FileSystem_MsgThread implements Runnable
{
	...
	public Send_FileSystem_MsgThread(Handler handler,Activity activity,String requestStr) 
	{
		super();
