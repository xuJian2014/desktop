...
public class Send_homeService_info implements Runnable
{
	...
	public Send_homeService_info(Handler handler,Activity activity,String requestStr) 
	{
		super();
